...
const FAQ = () => {
  ...
  return (
    <div className="px-2 py-4 sm:px-4 sm:py-8">
      ...
      <section className="flex flex-col items-center justify-center bg-[#555454] ">
      <div className="flex justify-center items-center">
        <div className="relative w-fit -mt-8 z-20">
        ...
        <div className="w-full max-w-2xl sm:max-w-4xl md:max-w-7xl mx-auto pt-10 pb-40">
          {faqs.map((faq, idx) => (
            <div key={idx} className="text-white overflow-hidden  last:border-b-0">
              <button
                onClick={() => toggleFAQ(idx)}
                className={`w-full py-4 px-2 sm:py-6 sm:px-6 text-center flex justify-center items-center transition-colors duration-200 ${openIndex === idx ? "": "underline"} underline-offset-8 sm:underline-offset-[20px] focus:outline-none`}
              >
                <h3 className="text-2xl xs:text-3xl sm:text-3xl md:text-4xl lg:text-6xl font-semibold text-center">
                  {faq.question}
                </h3>
              </button>
              <div
